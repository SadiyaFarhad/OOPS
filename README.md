# OOPS
Object-Oriented Programming (OOP) is a coding approach using "objects" that contain data and methods. Its core principles are:

1. Encapsulation: Keeping data and methods together and protected.
